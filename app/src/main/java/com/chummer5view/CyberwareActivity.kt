...
class CyberwareActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(R.string.action_cyberware)
...
/**
        ...
        val xpath1 = XmlPath + "/cyberwares/cyberware"
        val itemsTypeT1 = xPath.evaluate(xpath1, doc, XPathConstants.NODESET) as NodeList
        val itemList: MutableList<String> = ArrayList()
        for (i in 0..itemsTypeT1.length - 1) {
            if (getXPath(itemsTypeT1.item(i)) == "#document/characters/character/cyberwares/cyberware") {
...
//                        Log.d("XPath: ", getXPath(childNodes2.item(a)))
                    ...
                    if (childNodes2.item(a).nodeName == "rating") {
                        if (childNodes2.item(a).textContent.isNotEmpty() && childNodes2.item(a).textContent != "0") {
                            gearName = gearName + " (Stufe " + childNodes2.item(a).textContent + ")"
                        }
                    }
                ...
                if (gearName.isNotEmpty()){
                    itemList.add("Cyberware;" + gearName + ";")
                }
            }
        }
